    ...
    difference() {
        union() {
            ...
            difference() {
                ...
                translate([-1,2,-20])
                rotate([90,0,0])
                cylinder(h=15,r=3,$fn=30,center=true);
    ...
    union() {
        ...
        difference() {
            union() {
                ...
                translate([-32.5,-3.4,17])
                cube([10,2,8],center=true);
            }
            
            translate([-30,-3.4,9])
            cube([11,5,8],center=true);
        }
    ...
    difference() {
        union() {
            ...
            difference() {
                ...
                rotate([90,0,0])
                cylinder(h=12,r=2.3,$fn=30,center=true);
                
                translate([29.5,-1,2.5])
                rotate([90,0,0])
                cylinder(h=15,r=1.2,$fn=30,center=true);
            }
